...
Open MATLAB and navigate to the Project_Root directory so it is set as your Current Folder.

Ensure that the Data/Athletes/ directory contains the three required CSV files.

Open and run the main script (e.g., main.m).

The script will automatically create the Results/ and Results/Figures/ directories if they do not already exist.

The workspace variables will be saved to a .mat file, the summary table exported to a .csv, and all five analytical figures will be exported as .png files into the Results/Figures/ folder.
